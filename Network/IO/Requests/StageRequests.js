module.exports = class StageRequests {
   ...
   */
  static GroupAudioUpdate = async (io, id, enabled, minRepLevel, stageId) =>
   ...
   */
  static GroupAudioBroadcastUpdate = async (io, id, slotId, occupierId, occupierMuted) =>
   ...
   * @param {number} occupierId the id of the subscriber making the request
   */
  static GroupAudioBroadcastDisconnect = async (io, id, slotId, occupierId) =>
